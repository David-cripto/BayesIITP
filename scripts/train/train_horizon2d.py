...
from toysb import SB2D, Logger, RunnerHorizon2D
...
def create_arguments():
    ...
    parser.add_argument("--horizon", type=int, default=20, help="number of horizon steps")
...
def main(opt):
    ...
    net = SB2D(x_dim = dim)
    run = RunnerHorizon2D(opt, logger, net)
