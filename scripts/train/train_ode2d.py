...
from toysb import SB2D, Logger, RunnerODE
...
def create_arguments():
    ...
    parser.add_argument("--dataset1", type=str, help="name or path to initial dataset")
    parser.add_argument("--dataset2", type=str, help="name or path to terminal dataset")
...
def main(opt):
    ...
    net_f, net_b = SB2D(x_dim = dim), SB2D(x_dim = dim)
    run = RunnerODE(opt, logger, net_f, net_b)
